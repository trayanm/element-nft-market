...
import MarketPlace from "../abis/IMarketPlaceDiamond.json";
...
class AppProvider extends React.Component {
    ...
    checkStateAsync = async () => {
        if (this.state.mktIsLoading === true) {
            ...
            _state.marketPlaceInstance = new web3.eth.Contract(
                MarketPlace,
                '0x2085Fee6a941CE7a902b093d4306A255317631ba'
            );

            const userFunds = await this.state.marketPlaceInstance.methods.getUserFunds(this.state.account).call();
