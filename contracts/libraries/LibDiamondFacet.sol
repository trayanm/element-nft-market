...
library LibDiamondFacet {
    bytes32 constant STORAGE_POSITION = keccak256('elementmarket.storage.diamond');
    ...
    function setContractOwner(address _newOwner) internal {
        ...
        emit onOwnershipTransferred(previousOwner, _newOwner);
    }
    ...
    event onDiamondCut(IDiamondCutFacet.FacetCut[] _diamondCut, address _init, bytes _calldata);
    ...
    function diamondCut(
        ...
        emit onDiamondCut(_diamondCut, _init, _calldata);
